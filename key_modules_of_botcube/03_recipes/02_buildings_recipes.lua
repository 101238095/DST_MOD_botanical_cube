...
-- -- 加载资源
-- Assets = {
--     Asset("ATLAS", "images/ui_images/botanical_cube_buildings.xml"),
-- }

-- -- 定义一个新的过滤器对象
-- local filter_botanical_cube_buildings_def = {
--     name = "Botanical_Cube",
--     atlas = "images/ui_images/botanical_cube_buildings.xml",
--     image = "botanical_cube_buildings.tex"
-- }

-- -- 添加自定义过滤器
-- AddRecipeFilter(filter_botanical_cube_buildings_def, 1)
