...
local assets =
{
    ...
    Asset("ANIM", "anim/botanical_cube_others_glowworm_build.zip"),
...
local workersounds =
{
    takeoff = "grotto/creatures/light_bug/fly_LP",
    attack = "grotto/creatures/light_bug/fly_LP",
    buzz = "grotto/creatures/light_bug/fly_LP",
    hit = "grotto/creatures/light_bug/fly_LP",
    death = "grotto/creatures/light_bug/fly_LP",
}
...
local function commonfn(build, tags)
    ...
    inst.components.lootdropper:AddRandomLoot("lightbulb", 1)
    --inst.components.lootdropper:AddRandomLoot("lightbulb", 1)
...
local function workerbee()
    ...
    local inst = commonfn("botanical_cube_others_glowworm_build", { "worker", "pollinator" })
...
return Prefab("botanical_cube_others_glowworm", workerbee, assets, prefabs)
