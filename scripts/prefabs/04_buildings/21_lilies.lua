...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_lilies.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_lilies.tex")

    inst.AnimState:SetBank("botanical_cube_building_lilies")
    inst.AnimState:SetBuild("botanical_cube_building_lilies")
    ...
    inst:AddTag("botanical_cube_building_lilies")
...
return Prefab("botanical_cube_building_lilies", fn, assets),
    MakePlacer("botanical_cube_building_lilies_placer", "botanical_cube_building_lilies", "botanical_cube_building_lilies", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
