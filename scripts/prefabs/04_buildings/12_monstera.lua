...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_monstera.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_monstera.tex")

    inst.AnimState:SetBank("botanical_cube_building_monstera")
    inst.AnimState:SetBuild("botanical_cube_building_monstera")
    ...
    inst:AddTag("botanical_cube_building_monstera")
...
return Prefab("botanical_cube_building_monstera", fn, assets),
    MakePlacer("botanical_cube_building_monstera_placer", "botanical_cube_building_monstera", "botanical_cube_building_monstera", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
