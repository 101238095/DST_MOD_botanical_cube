...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_platycerium.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_platycerium.tex")

    inst.AnimState:SetBank("botanical_cube_building_platycerium")
    inst.AnimState:SetBuild("botanical_cube_building_platycerium")
    ...
    inst:AddTag("botanical_cube_building_platycerium")
...
return Prefab("botanical_cube_building_platycerium", fn, assets),
    MakePlacer("botanical_cube_building_platycerium_placer", "botanical_cube_building_platycerium", "botanical_cube_building_platycerium", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
