...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_butterflybox.zip"),
...
local function MakeBeebox(name, common_postinit, master_postinit)
    ...
    local function fn()
        ...
        inst.MiniMapEntity:SetIcon("botanical_cube_building_butterflybox.png")

        inst.AnimState:SetBank("botanical_cube_building_butterflybox")
        inst.AnimState:SetBuild("botanical_cube_building_butterflybox")
        ...
        inst.components.harvestable:SetUp("lightbulb", 6, nil, onharvest, updatelevel)
        inst:ListenForEvent("childgoinghome", onchildgoinghome)
        -------------------

        inst:AddComponent("childspawner")
        inst.components.childspawner.childname = "botanical_cube_others_glowworm"--产卵者
...
local function botanical_cube_building_butterflybox_common(inst)
    inst.AnimState:SetBank("botanical_cube_building_butterflybox")
    inst.AnimState:SetBuild("botanical_cube_building_butterflybox")
    inst.AnimState:PlayAnimation("idle")
end
...
--]]
local function botanical_cube_building_butterflybox_master(inst)
...
local function botanical_cube_building_butterflybox_hermit_master(inst)

end

return MakeBeebox("botanical_cube_building_butterflybox", botanical_cube_building_butterflybox_common, botanical_cube_building_butterflybox_master),
       MakePlacer("botanical_cube_building_butterflybox_placer", "botanical_cube_building_butterflybox", "botanical_cube_building_butterflybox", "idle")
