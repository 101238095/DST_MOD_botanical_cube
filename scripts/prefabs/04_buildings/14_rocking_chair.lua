...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_rocking_chair.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_rocking_chair.tex")

    inst.AnimState:SetBank("botanical_cube_building_rocking_chair")
    inst.AnimState:SetBuild("botanical_cube_building_rocking_chair")
    ...
    inst:AddTag("botanical_cube_building_rocking_chair")
...
return Prefab("botanical_cube_building_rocking_chair", fn, assets),
    MakePlacer("botanical_cube_building_rocking_chair_placer", "botanical_cube_building_rocking_chair", "botanical_cube_building_rocking_chair", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
