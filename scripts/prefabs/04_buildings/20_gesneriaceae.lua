...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_gesneriaceae.zip"),
...
local function fn()
    ...
    --inst.MiniMapEntity:SetIcon("botanical_cube_building_gesneriaceae.tex")

    inst.AnimState:SetBank("botanical_cube_building_gesneriaceae")
    inst.AnimState:SetBuild("botanical_cube_building_gesneriaceae")
    ...
    inst:AddTag("botanical_cube_building_gesneriaceae")
    ...
    inst.components.botanical_cube_upgrade.max = 4              --最多可以给予10个
...
return Prefab("botanical_cube_building_gesneriaceae", fn, assets),
    MakePlacer("botanical_cube_building_gesneriaceae_placer", "botanical_cube_building_gesneriaceae", "botanical_cube_building_gesneriaceae", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
