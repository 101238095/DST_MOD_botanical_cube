...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_flowers.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("botanical_cube_building_flowers")
    inst.AnimState:SetBuild("botanical_cube_building_flowers")
    ...
    inst:AddTag("botanical_cube_building_flowers")
...
return Prefab("botanical_cube_building_flowers", fn, assets),
    MakePlacer("botanical_cube_building_flowers_placer", "botanical_cube_building_flowers", "botanical_cube_building_flowers", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
