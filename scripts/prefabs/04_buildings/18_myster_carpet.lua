...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_myster_carpet.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_myster_carpet.tex")

    inst.AnimState:SetBank("botanical_cube_building_myster_carpet")
    inst.AnimState:SetBuild("botanical_cube_building_myster_carpet")
    ...
    inst:AddTag("botanical_cube_building_myster_carpet")
    ...
    inst.components.botanical_cube_upgrade.item = "beefalowool" --用牛毛升级
...
return Prefab("botanical_cube_building_myster_carpet", fn, assets),
    MakePlacer("botanical_cube_building_myster_carpet_placer", "botanical_cube_building_myster_carpet", "botanical_cube_building_myster_carpet", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
