...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_arrowroot.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("botanical_cube_building_arrowroot")
    inst.AnimState:SetBuild("botanical_cube_building_arrowroot")
    ...
    inst:AddTag("botanical_cube_building_arrowroot")
...
return Prefab("botanical_cube_building_arrowroot", fn, assets),
    MakePlacer("botanical_cube_building_arrowroot_placer", "botanical_cube_building_arrowroot", "botanical_cube_building_arrowroot", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
