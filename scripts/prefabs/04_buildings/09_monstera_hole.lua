...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_monstera_hole.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_monstera_hole.tex")

    inst.AnimState:SetBank("botanical_cube_building_monstera_hole")
    inst.AnimState:SetBuild("botanical_cube_building_monstera_hole")
    ...
    inst:AddTag("botanical_cube_building_monstera_hole")
...
return Prefab("botanical_cube_building_monstera_hole", fn, assets),
    MakePlacer("botanical_cube_building_monstera_hole_placer", "botanical_cube_building_monstera_hole", "botanical_cube_building_monstera_hole", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
