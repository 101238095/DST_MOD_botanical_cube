...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_leaf_carpet.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_leaf_carpet.tex")

    inst.AnimState:SetBank("botanical_cube_building_leaf_carpet")
    inst.AnimState:SetBuild("botanical_cube_building_leaf_carpet")
    ...
    inst:AddTag("botanical_cube_building_leaf_carpet")
...
return Prefab("botanical_cube_building_leaf_carpet", fn, assets),
    MakePlacer("botanical_cube_building_leaf_carpet_placer", "botanical_cube_building_leaf_carpet", "botanical_cube_building_leaf_carpet", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
