...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_happy_leaf.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("botanical_cube_building_happy_leaf")
    inst.AnimState:SetBuild("botanical_cube_building_happy_leaf")
    ...
    inst:AddTag("botanical_cube_building_happy_leaf")
...
return Prefab("botanical_cube_building_happy_leaf", fn, assets),
    MakePlacer("botanical_cube_building_happy_leaf_placer", "botanical_cube_building_happy_leaf", "botanical_cube_building_happy_leaf", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
