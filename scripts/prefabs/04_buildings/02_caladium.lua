...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_caladium.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("botanical_cube_building_caladium")
    inst.AnimState:SetBuild("botanical_cube_building_caladium")
    ...
    inst:AddTag("botanical_cube_building_caladium")
...
return Prefab("botanical_cube_building_caladium", fn, assets),
    MakePlacer("botanical_cube_building_caladium_placer", "botanical_cube_building_caladium", "botanical_cube_building_caladium", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
