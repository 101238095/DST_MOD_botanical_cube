...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_garland.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("botanical_cube_building_garland")
    inst.AnimState:SetBuild("botanical_cube_building_garland")
    ...
    inst:AddTag("botanical_cube_building_garland")
...
return Prefab("botanical_cube_building_garland", fn, assets),
    MakePlacer("botanical_cube_building_garland_placer", "botanical_cube_building_garland", "botanical_cube_building_garland", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
