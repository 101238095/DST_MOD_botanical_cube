...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_begonia.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_begonia.tex")

    inst.AnimState:SetBank("botanical_cube_building_begonia")
    inst.AnimState:SetBuild("botanical_cube_building_begonia")
    ...
    inst:AddTag("botanical_cube_building_begonia")
...
return Prefab("botanical_cube_building_begonia", fn, assets),
    MakePlacer("botanical_cube_building_begonia_placer", "botanical_cube_building_begonia", "botanical_cube_building_begonia", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
