...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_bromeliad.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_bromeliad.tex")

    inst.AnimState:SetBank("botanical_cube_building_bromeliad")
    inst.AnimState:SetBuild("botanical_cube_building_bromeliad")
    ...
    inst:AddTag("botanical_cube_building_bromeliad")
...
return Prefab("botanical_cube_building_bromeliad", fn, assets),
    MakePlacer("botanical_cube_building_bromeliad_placer", "botanical_cube_building_bromeliad", "botanical_cube_building_bromeliad", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
