...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_daisy.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_daisy.tex")

    inst.AnimState:SetBank("botanical_cube_building_daisy")
    inst.AnimState:SetBuild("botanical_cube_building_daisy")
    ...
    inst:AddTag("botanical_cube_building_daisy")
...
return Prefab("botanical_cube_building_daisy", fn, assets),
    MakePlacer("botanical_cube_building_daisy_placer", "botanical_cube_building_daisy", "botanical_cube_building_daisy", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
