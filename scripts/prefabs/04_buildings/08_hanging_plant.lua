...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_hanging_plant.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_hanging_plant.tex")

    inst.AnimState:SetBank("botanical_cube_building_hanging_plant")
    inst.AnimState:SetBuild("botanical_cube_building_hanging_plant")
    ...
    inst:AddTag("botanical_cube_building_hanging_plant")
...
return Prefab("botanical_cube_building_hanging_plant", fn, assets),
    MakePlacer("botanical_cube_building_hanging_plant_placer", "botanical_cube_building_hanging_plant", "botanical_cube_building_hanging_plant", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
