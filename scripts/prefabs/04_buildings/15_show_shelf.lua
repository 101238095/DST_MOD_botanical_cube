...
local assets =
{
    Asset("ANIM", "anim/botanical_cube_building_show_shelf.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("botanical_cube_building_show_shelf.tex")

    inst.AnimState:SetBank("botanical_cube_building_show_shelf")
    inst.AnimState:SetBuild("botanical_cube_building_show_shelf")
    ...
    inst:AddTag("botanical_cube_building_show_shelf")
...
return Prefab("botanical_cube_building_show_shelf", fn, assets),
    MakePlacer("botanical_cube_building_show_shelf_placer", "botanical_cube_building_show_shelf", "botanical_cube_building_show_shelf", "idle", nil, nil, nil, nil, nil, nil, placer_postinit_fn)
